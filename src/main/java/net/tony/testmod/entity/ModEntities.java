...
public class ModEntities {
    ...
    public static final EntityType<CarEntity> CAR = Registry.register(Registries.ENTITY_TYPE,
            new Identifier(TestMod.MOD_ID, "car"),
            FabricEntityTypeBuilder.create(SpawnGroup.CREATURE, CarEntity::new)
                    .dimensions(EntityDimensions.fixed(1f, 1f)).build());
}
